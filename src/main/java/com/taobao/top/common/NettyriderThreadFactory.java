 ...
 *
 */
public class NettyriderThreadFactory implements ThreadFactory {
	...
	public NettyriderThreadFactory(String prefix) {
		this(prefix, null, false);
	}
	
	public NettyriderThreadFactory(String prefix, ThreadGroup group, boolean isDaemon) {
